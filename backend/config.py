...
# Flask
JWT_SECRET_KEY = _env('JWT_SECRET_KEY', 'flaskcli')
JWT_ACCESS_TOKEN_EXPIRES = int(_env('JWT_ACCESS_TOKEN_EXPIRES', 86400 * 7))
JWT_REFRESH_TOKEN_EXPIRES = int(_env('JWT_REFRESH_TOKEN_EXPIRES', 86400 * 30))
